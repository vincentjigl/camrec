...
JglRecorder::JglRecorder(const String16 &opPackageName)
...
sp<IGraphicBufferProducer> JglRecorder::querySurfaceMediaSource() const {
    ALOGV("Get SurfaceMediaSource");
    return mGraphicBufferProducer;
}

status_t JglRecorder::setAudioSource(audio_source_t as) {
...
status_t JglRecorder::setVideoSource(video_source vs) {
...
status_t JglRecorder::setOutputFormat(output_format of) {
...
status_t JglRecorder::setAudioEncoder(audio_encoder ae) {
...
status_t JglRecorder::setVideoEncoder(video_encoder ve) {
...
status_t JglRecorder::setVideoSize(int width, int height) {
...
status_t JglRecorder::setVideoFrameRate(int frames_per_second) {
...
status_t JglRecorder::setCamera(const sp<hardware::ICamera> &camera,
...
status_t JglRecorder::setPreviewSurface(const sp<IGraphicBufferProducer> &surface) {
...
status_t JglRecorder::setInputSurface(
...
status_t JglRecorder::setOutputFile(int fd, int64_t offset, int64_t length) {
...
status_t JglRecorder::setParamAudioSamplingRate(int32_t sampleRate) {
...
status_t JglRecorder::setParamAudioNumberOfChannels(int32_t channels) {
...
status_t JglRecorder::setParamAudioEncodingBitRate(int32_t bitRate) {
...
status_t JglRecorder::setParamVideoEncodingBitRate(int32_t bitRate) {
...
status_t JglRecorder::setParamVideoRotation(int32_t degrees) {
...
status_t JglRecorder::setParamMaxFileDurationUs(int64_t timeUs) {
...
status_t JglRecorder::setParamMaxFileSizeBytes(int64_t bytes) {
...
status_t JglRecorder::setParamInterleaveDuration(int32_t durationUs) {
...
status_t JglRecorder::setParamVideoIFramesInterval(int32_t seconds) {
    ALOGV("setParamVideoIFramesInterval: %d seconds", seconds);
    mIFramesIntervalSec = seconds;
    return OK;
}

status_t JglRecorder::setParam64BitFileOffset(bool use64Bit) {
...
status_t JglRecorder::setParamVideoCameraId(int32_t cameraId) {
...
status_t JglRecorder::setParamTrackTimeStatus(int64_t timeDurationUs) {
...
status_t JglRecorder::setParamVideoEncoderProfile(int32_t profile) {
...
status_t JglRecorder::setParamVideoEncoderLevel(int32_t level) {
...
status_t JglRecorder::setParamMovieTimeScale(int32_t timeScale) {
...
status_t JglRecorder::setParamVideoSvcLayer(int32_t svcLayer) {
    ALOGE("setParamVideoSvcLayer: %d", svcLayer);

    mVideoSvcLayer = svcLayer;
    return OK;
}

status_t JglRecorder::setParamVideoSliceHeight(int32_t sliceHeight) {
    ALOGE("setParamVideoSliceHeight: %d", sliceHeight);

    mVideoSliceHeight = sliceHeight;
    return OK;
}

status_t JglRecorder::setParamVideoTimeScale(int32_t timeScale) {
...
status_t JglRecorder::setParamAudioTimeScale(int32_t timeScale) {
...
status_t JglRecorder::setParamCaptureFpsEnable(int32_t captureFpsEnable) {
...
status_t JglRecorder::setParamCaptureFps(float fps) {
...
status_t JglRecorder::setParamGeoDataLongitude(
...
status_t JglRecorder::setParamGeoDataLatitude(
...
status_t JglRecorder::setParameter(
    ...
    } else if (key == "video-param-svc-layer") {
        int32_t svcLayer;
        if (safe_strtoi32(value.string(), &svcLayer)) {
            return setParamVideoSvcLayer(svcLayer);
        }
    } else if (key == "video-param-slice-height") {
        int32_t sliceHeight;
        if (safe_strtoi32(value.string(), &sliceHeight)) {
            return setParamVideoSliceHeight(sliceHeight);
        }
...
status_t JglRecorder::setParameters(const String8 &params) {
...
status_t JglRecorder::setListener(const sp<IMediaRecorderClient> &listener) {
    mListener = listener;

    return OK;
}

status_t JglRecorder::setClientName(const String16& clientName) {
    mClientName = clientName;

    return OK;
}

status_t JglRecorder::prepareInternal() {
    ALOGV("prepare");
    if (mOutputFd < 0) {
...
status_t JglRecorder::start(sp<MediaCodecSource> *encoder) {
    ALOGV("start");
    if (mOutputFd < 0) {
        ALOGE("Output file descriptor is invalid");
        return INVALID_OPERATION;
    ...
    switch (mOutputFormat) {
        ...
        case OUTPUT_FORMAT_WEBM:
        {
            ...
            status = mVideoEncoderSource->start(meta.get());
            break;
        }
        default:
        {
	...
	*encoder = mVideoEncoderSource;

    return status;
}

status_t JglRecorder::start() {
    ALOGV("start");
    if (mOutputFd < 0) {
        ALOGE("Output file descriptor is invalid");
        return INVALID_OPERATION;
...
sp<MediaCodecSource> JglRecorder::createAudioSource() {
...
status_t JglRecorder::setupAACRecording() {
    // FIXME:
...
status_t JglRecorder::setupAMRRecording() {
...
status_t JglRecorder::setupRawAudioRecording() {
...
status_t JglRecorder::setupRTPRecording() {
...
status_t JglRecorder::setupMPEG2TSRecording() {
...
void JglRecorder::clipVideoFrameRate() {
...
void JglRecorder::clipVideoBitRate() {
...
void JglRecorder::clipVideoFrameWidth() {
...
status_t JglRecorder::checkVideoEncoderCapabilities() {
...
void JglRecorder::setDefaultProfileIfNecessary() {
...
void JglRecorder::setDefaultVideoEncoderIfNecessary() {
...
status_t JglRecorder::checkAudioEncoderCapabilities() {
    clipAudioBitRate();
    clipAudioSampleRate();
...
void JglRecorder::clipAudioBitRate() {
...
void JglRecorder::clipAudioSampleRate() {
...
void JglRecorder::clipNumberOfAudioChannels() {
...
void JglRecorder::clipVideoFrameHeight() {
...
status_t JglRecorder::setupMediaSource(
                      sp<MediaSource> *mediaSource) {
...
status_t JglRecorder::setupCameraSource(
        sp<CameraSource> *cameraSource) {
    status_t err = OK;
...
status_t JglRecorder::setupVideoEncoder(
    ...
    if (mVideoSvcLayer > 0) {
        format->setInt32("svc-layer", mVideoSvcLayer);
    }
    if (mVideoSliceHeight > 0) {
        format->setInt32("video-slice-height", mVideoSliceHeight);
    }
...
status_t JglRecorder::setupAudioEncoder(const sp<MediaWriter>& writer) {
    status_t status = BAD_VALUE;
    if (OK != (status = checkAudioEncoderCapabilities())) {
        return status;
    }
...
status_t JglRecorder::setupMPEG4orWEBMRecording() {
    mWriter.clear();
    mTotalBitRate = 0;
...
void JglRecorder::setupMPEG4orWEBMMetaData(sp<MetaData> *meta) {
...
status_t JglRecorder::getMaxAmplitude(int *max) {
